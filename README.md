...
* Added setOptions function to DrawingManager to support custom drawing styles
...
async function onMapsReady() {
    ...
    // Now build the map/application...
}
</script>
<!-- Do NOT include libraries=drawing in the script src -->
